...
const {dataHandling,productsHistory,filterByCategory,filterByPrice,deleteProducts} = require('../contollers/inventoryControllers')
...
router.get('/inventory/product/data')
